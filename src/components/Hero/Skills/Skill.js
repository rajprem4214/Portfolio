...
const Skill = () => {
  return (
    <div className="project">
      ...
      <div data-aos="fade-right" className="pimage">
        <img
      ...
      <ul data-aos="fade-left" className="tech-list">
        <li>Ethereum</li>
        <li>Truffle</li>
        <li>Metamask</li>
        <li>Web3</li>
      ...
      >
        <p className="parag parag2">
          ...
          <br />
          <p data-aos="fade-right" className="p-link p-link2">
            <a
      ...
      <ul data-aos="fade-right" className="tech-list tech-list2">
        <li>VS Code</li>
        <li>ReactJS</li>
        <li>NodeJs</li>
        <li>API</li>
      ...
      <div data-aos="fade-right" className="pimage pimage3">
        <img
